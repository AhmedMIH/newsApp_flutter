...
class HeadlinesSliderWidget extends StatefulWidget {
  @override
  _HeadlinesSliderWidget createState() => _HeadlinesSliderWidget();
}

class _HeadlinesSliderWidget extends State<HeadlinesSliderWidget> {
  @override
  void initState() {
    super.initState();
    ...
    return StreamBuilder(
      ...
      builder: (context, AsyncSnapshot<ArticleResponse> snapshot) {
        if (snapshot.hasData) {
          ...
          return _buildHeadlineSliderWidget(snapshot.data.articles);
  ...
  Widget _buildHeadlineSliderWidget(List<Articles> data) {
    List<Articles> articles = data;
    return Container(
  ...
  getExpenseSliders(List<Articles> articles) {
    return articles
        .map(
